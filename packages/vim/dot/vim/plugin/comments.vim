...
function! CommentLine()
  ...
  if file_name =~ '\.cpp$' || file_name =~ '\.hpp$' || file_name =~ '\.java$' || file_name =~ '\.php[2345]\?$' || file_name =~ '\.C$' || file_name =~ '\.ino$' || file_name =~ '\.pde$' || file_name =~ '\.go$' || file_name =~ '\.js$' || file_name =~ '\.less$' || file_name =~ '\.styl$'
...
function! RangeUnCommentLine()
  ...
  " for .cpp or .hpp or .java or .js or arduino (*.ino or *.pde) or go files use //
  if file_name =~ '\.cpp$' || file_name =~ '\.hpp$' || file_name =~ '\.java$' || file_name =~ '\.php[2345]\?$' || file_name =~ '\.C$' || file_name =~ '\.ino$' || file_name =~ '\.pde$' || file_name =~ '\.go$' || file_name =~ '\.js$' || file_name =~ '\.less$'
